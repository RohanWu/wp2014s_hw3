(function(){
	...
	var e = {};
	["loginView","evaluationView","updateSuccessView"].forEach(function(index){
		templateCode = document.getElementById(index).text;
		e[index] = doT.template(templateCode);
	});
	
	var t={
		loginRequiredView:function(input){
			return function(){
